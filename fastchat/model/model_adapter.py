...
class MPTInstruct30BAdapter(MPTChat30BAdapter):
    """The model adapter for mosaicml/mpt-30b-instruct"""

    use_fast_tokenizer = True

    def match(self, model_path: str):
        return "mpt-30b-instruct" in model_path
...
register_model_adapter(MPTInstruct30BAdapter)
