...
- [Chatbot Arena](https://lmsys.org/blog/2023-05-03-arena/) - a crowdsourced, randomized battle platform. We use 40K+ votes from users to compute Elo ratings.
- [MT-Bench](https://arxiv.org/abs/2306.05685) - a set of challenging multi-turn questions. We use GPT-4 to grade the model responses.
- [MMLU](https://arxiv.org/abs/2009.03300) (5-shot) - a test to measure a model's multitask accuracy. The test covers 57 tasks including elementary mathematics, US history, computer science, law, and more.

💻 The MT-bench scores (single-answer grading on a scale of 10) and win rates (against gpt-3.5) are computed by [fastchat.llm_judge](https://github.com/lm-sys/FastChat-dev/tree/llm-judge/fastchat/llm_judge). The Arena Elo ratings are computed by this [notebook]({notebook_url}). The MMLU scores are computed by [InstructEval](https://github.com/declare-lab/instruct-eval) and [Chain-of-Thought Hub](https://github.com/FranxYao/chain-of-thought-hub). Higher values are better for all benchmarks. Empty cells mean not available.
"""
