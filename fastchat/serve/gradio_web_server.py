...
learn_more_markdown = ("""
### Evaluation Samples
The online demo has limited capacity. If you are waiting in the queue, feel free to explore some sample outputs of the models on our benchmark questions by visiting our static website [here](https://vicuna.lmsys.org/eval).
