...
"""
    ...
    with gr.Row():
        with gr.Column(scale=3):
            ...
            # TODO(chris): fix these links and add good examples
            # gr.Examples(examples=[
            #     [f"{cur_dir}/playground/images/python.png", "What is this a logo of?"],
            #     [f"{cur_dir}/playground/images/sunset.jpg", "Where was this picture taken?"],
