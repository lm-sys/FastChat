...
def get_answer(
    question: dict, model: str, num_choices: int, max_tokens: int, answer_file: str, api_dict: str = None
):
    assert (
...
if __name__ == "__main__":
    ...
    parser.add_argument("--openai-api-base", type=str, default="https://api.openai.com/v1")
    args = parser.parse_args()

    api_dict = {"api_key": os.getenv("OPENAI_API_KEY", "random api key"), "api_base": args.openai_api_base}
