...
A standlone script is also available at `polar_plot.py`. It relies on a configuration filename (for which an example can be found in `./data/mt_bench/polar_plot_configs/gpt4-judge-all.json`) and to run it:
