...
1. Contribute code to support the new model in FastChat by submitting a pull request.  
   ...
   - (Optional) add the model name to the "Supported Models" section in [README.md](https://github.com/lm-sys/FastChat#supported-models) and add more inforamtion in [fastchat/model/model_registry.py](https://github.com/lm-sys/FastChat/blob/main/).
