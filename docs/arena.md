...
1. Contribute code to support the new model in FastChat by submitting a pull request.  
   ...
   - (Optional) add the model names to [README.md](https://github.com/lm-sys/FastChat#supported-models) and [fastchat/model/model_registry.py](https://github.com/lm-sys/FastChat/blob/main/).
