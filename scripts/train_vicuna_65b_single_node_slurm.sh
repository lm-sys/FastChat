...
python -m torch.distributed.run --nproc_per_node=16 --nnodes $SLURM_NNODES --node_rank=$SLURM_PROCID \
    ...
    --model_name_or_path /nfs/projects/mbzuai/ext_hao.zhang/hao/dataset/llama-65b \
    --data_path /nfs/projects/mbzuai/ext_hao.zhang/hao/dataset/sharegpt_20230521_clean_lang_split_identity_gpt4.json \
    --fp16 True \
    --output_dir /nfs/projects/mbzuai/ext_hao.zhang/hao/FastChat/vicuna_65b_sharegpt_20230521_64GPU_gpt4 \
    --num_train_epochs 4 \
